...
def test_flat_demand_creates_month_peaks_only_for_months_in_run_and_uses_month_rates():
    ...
    assert hasattr(m.utility, "P_flat_m1")
    assert not hasattr(m.utility, "P_flat_m2")
    ...
    m.utility.P_flat_m0.value = 5.0
    m.utility.P_flat_m1.value = 7.0
...
def test_tou_demand_creates_month_tier_peaks_only_when_tier_occurs_in_month():
    ...
    m = build_model(data, technology_parameters={}, financials={})
    assert hasattr(m, "utility")
    assert hasattr(m.utility, "P_tou_m0_tier1")
    assert hasattr(m.utility, "P_tou_m1_tier2")
    assert not hasattr(m.utility, "P_tou_m0_tier2")
    assert not hasattr(m.utility, "P_tou_m1_tier1")
...
def test_tou_demand_charge_cost_sums_month_tier_peaks():
    ...
    m.utility.P_tou_m0_tier1.value = 5.0
    m.utility.P_tou_m1_tier2.value = 7.0
